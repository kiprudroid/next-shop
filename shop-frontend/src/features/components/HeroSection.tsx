const HeroSection = () => {
  return (
    <section className="hero-section bg-gray-100 py-12 bg-cover bg-center h-200" style={{ backgroundImage: "url('/Hero.jpeg')" } }>
      <div className="heroContent container mx-auto text-left text-white px-4 flex flex-row">
        <div className="w-full md:w-1/2 max-w-xl py-8 md:py-12 lg:py-16 px-4 md:px-8 lg:px-12">
          ...
          <h1 className="text-5xl md:text-6xl font-extrabold leading-tight mb-6 text-gray-500">
            Elevate Your
            <br />
            <span className="text-blue-600">Style</span>
          </h1>

          <p className="text-2xl text-gray-200 leading-relaxed mb-10 max-w-md">
